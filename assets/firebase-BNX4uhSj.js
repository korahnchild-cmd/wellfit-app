 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ef="storage";function IA(n,e,t){return n=te(n),PI(n,e,t)}function wA(n){return n=te(n),CI(n)}function AA(n){return n=te(n),kI(n)}function RA(n,e){return n=te(n),OI(n,e)}function bA(n=zs(),e){n=te(n);const r=Ut(n,Ef).getImmediate({identifier:e}),s=Nl("storage");return s&&MI(r,...s),r}function MI(n,e,t,r={}){LI(n,e,t,r)}function xI(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new Na(t,r,s,e,ln)}function UI(){We(new Fe(Ef,xI,"PUBLIC").setMultipleInstances(!0)),Ne(yl,vl,""),Ne(yl,vl,"esm2017")}UI();const Tf="@firebase/installations",Va="0.6.18";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
