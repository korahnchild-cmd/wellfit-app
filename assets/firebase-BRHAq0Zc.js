 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hh(n){const e=jt(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function sA(n,e,t){if(ke(n.app))return Promise.reject(ct(n));const r=jt(n),a=await uo(r,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",t_).catch(l=>{throw l.code==="auth/password-does-not-meet-requirements"&&hh(n),l}),c=await nn._fromIdTokenResponse(r,"signIn",a);return await r._updateCurrentUser(c.user),c}function iA(n,e,t){return ke(n.app)?Promise.reject(ct(n)):s_(te(n),Dn.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&hh(n),r})}function i_(n,e,t,r){return te(n).onIdTokenChanged(e,t,r)}function o_(n,e,t){return te(n).beforeAuthStateChanged(e,t)}function oA(n,e,t,r){return te(n).onAuthStateChanged(e,t,r)}function aA(n){return te(n).signOut()}const Ss="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vr=-1;function Py(n,e){const t=n.toTimestamp().seconds,r=n.toTimestamp().nanoseconds+1,s=B.fromTimestamp(r===1e9?new ee(t+1,0):new ee(t,r));return new Dt(s,L.empty(),e)}function Cy(n){return new Dt(n.readTime,n.key,vr)}class Dt{constructor(e,t,r){this.readTime=e,this.documentKey=t,this.largestBatchId=r}static min(){return new Dt(B.min(),L.empty(),vr)}static max(){return new Dt(B.max(),L.empty(),vr)}}function ky(n,e){let t=n.readTime.compareTo(e.readTime);return t!==0?t:(t=L.comparator(n.documentKey,e.documentKey),t!==0?t:q(n.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dy="The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";class Ny{constructor(){this.onCommittedListeners=[]}addOnCommittedListener(e){this.onCommittedListeners.push(e)}raiseOnCommittedEvent(){this.onCommittedListeners.forEach((e=>e()))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Vn(n){if(n.code!==S.FAILED_PRECONDITION||n.message!==Dy)throw n;O("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Go=-1;function Js(n){return n==null}function Cs(n){return n===0&&1/n==-1/0}function Oy(n){return typeof n=="number"&&Number.isInteger(n)&&!Cs(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oh="";function Ly(n){let e="";for(let t=0;t<n.length;t++)e.length>0&&(e=Ru(e)),e=My(n.get(t),e);return Ru(e)}function My(n,e){let t=e;const r=n.length;for(let s=0;s<r;s++){const i=n.charAt(s);switch(i){case"\0":t+="";break;case Oh:t+="";break;default:t+=i}}return t}function Ru(n){return n+Oh+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _e{constructor(e){this.binaryString=e}static fromBase64String(e){const t=(function(s){try{return atob(s)}catch(i){throw typeof DOMException<"u"&&i instanceof DOMException?new Mh("Invalid base64 string: "+i):i}})(e);return new _e(t)}static fromUint8Array(e){const t=(function(s){let i="";for(let a=0;a<s.length;++a)i+=String.fromCharCode(s[a]);return i})(e);return new _e(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return(function(t){return btoa(t)})(this.binaryString)}toUint8Array(){return(function(t){const r=new Uint8Array(t.length);for(let s=0;s<t.length;s++)r[s]=t.charCodeAt(s);return r})(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return q(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}_e.EMPTY_BYTE_STRING=new _e("");const xy=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function Nt(n){if(Q(!!n,39018),typeof n=="string"){let e=0;const t=xy.exec(n);if(Q(!!t,46558,{timestamp:n}),t[1]){let s=t[1];s=(s+"000000000").substr(0,9),e=Number(s)}const r=new Date(n);return{seconds:Math.floor(r.getTime()/1e3),nanos:e}}return{seconds:oe(n.seconds),nanos:oe(n.nanos)}}function oe(n){return typeof n=="number"?n:typeof n=="string"?Number(n):0}function Vt(n){return typeof n=="string"?_e.fromBase64String(n):_e.fromUint8Array(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wr{constructor(e,t="asc"){this.field=e,this.dir=t}}function $y(n,e){return n.dir===e.dir&&n.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xy{constructor(e,t=null,r=[],s=[],i=null,a=null,c=null){this.path=e,this.collectionGroup=t,this.orderBy=r,this.filters=s,this.limit=i,this.startAt=a,this.endAt=c,this.Pe=null}}function Lu(n,e=null,t=[],r=[],s=null,i=null,a=null){return new Xy(n,e,t,r,s,i,a)}function Jo(n){const e=j(n);if(e.Pe===null){let t=e.path.canonicalString();e.collectionGroup!==null&&(t+="|cg:"+e.collectionGroup),t+="|f:",t+=e.filters.map((r=>go(r))).join(","),t+="|ob:",t+=e.orderBy.map((r=>(function(i){return i.field.canonicalString()+i.dir})(r))).join(","),Js(e.limit)||(t+="|l:",t+=e.limit),e.startAt&&(t+="|lb:",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map((r=>Pn(r))).join(",")),e.endAt&&(t+="|ub:",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map((r=>Pn(r))).join(",")),e.Pe=t}return e.Pe}function Xo(n,e){if(n.limit!==e.limit||n.orderBy.length!==e.orderBy.length)return!1;for(let t=0;t<n.orderBy.length;t++)if(!$y(n.orderBy[t],e.orderBy[t]))return!1;if(n.filters.length!==e.filters.length)return!1;for(let t=0;t<n.filters.length;t++)if(!Gh(n.filters[t],e.filters[t]))return!1;return n.collectionGroup===e.collectionGroup&&!!n.path.isEqual(e.path)&&!!Ou(n.startAt,e.startAt)&&Ou(n.endAt,e.endAt)}function _o(n){return L.isDocumentKey(n.path)&&n.collectionGroup===null&&n.filters.length===0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nv=new ne(L.comparator);function ft(){return nv}const Zh=new ne(L.comparator);function ir(...n){let e=Zh;for(const t of n)e=e.insert(t.key,t);return e}function ed(n){let e=Zh;return n.forEach(((t,r)=>e=e.insert(t,r.overlayedDocument))),e}function Xt(){return dr()}function td(){return dr()}function dr(){return new hn((n=>n.toString()),((n,e)=>n.isEqual(e)))}const rv=new ne(L.comparator),sv=new he(L.comparator);function W(...n){let e=sv;for(const t of n)e=e.add(t);return e}const iv=new he(q);function ov(){return iv}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zo(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Cs(e)?"-0":e}}function nd(n){return{integerValue:""+n}}function av(n,e){return Oy(e)?nd(e):Zo(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lv{constructor(e,t){this.field=e,this.transform=t}}function hv(n,e){return n.field.isEqual(e.field)&&(function(r,s){return r instanceof Rr&&s instanceof Rr||r instanceof br&&s instanceof br?bn(r.elements,s.elements,nt):r instanceof Os&&s instanceof Os?nt(r.Ee,s.Ee):r instanceof Ar&&s instanceof Ar})(n.transform,e.transform)}class dv{constructor(e,t){this.version=e,this.transformResults=t}}class He{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new He}static exists(e){return new He(void 0,e)}static updateTime(e){return new He(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function ys(n,e){return n.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(n.updateTime):n.exists===void 0||n.exists===e.isFoundDocument()}class ti{}function ad(n,e){if(!n.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return n.isNoDocument()?new ud(n.key,He.none()):new Vr(n.key,n.data,He.none());{const t=n.data,r=De.empty();let s=new he(ge.comparator);for(let i of e.fields)if(!s.has(i)){let a=t.field(i);a===null&&i.length>1&&(i=i.popLast(),a=t.field(i)),a===null?r.delete(i):r.set(i,a),s=s.add(i)}return new qt(n.key,r,new Le(s.toArray()),He.none())}}function fv(n,e,t){n instanceof Vr?(function(s,i,a){const c=s.value.clone(),l=Fu(s.fieldTransforms,i,a.transformResults);c.setAll(l),i.convertToFoundDocument(a.version,c).setHasCommittedMutations()})(n,e,t):n instanceof qt?(function(s,i,a){if(!ys(s.precondition,i))return void i.convertToUnknownDocument(a.version);const c=Fu(s.fieldTransforms,i,a.transformResults),l=i.data;l.setAll(cd(s)),l.setAll(c),i.convertToFoundDocument(a.version,l).setHasCommittedMutations()})(n,e,t):(function(s,i,a){i.convertToNoDocument(a.version).setHasCommittedMutations()})(0,e,t)}function fr(n,e,t,r){return n instanceof Vr?(function(i,a,c,l){if(!ys(i.precondition,a))return c;const d=i.value.clone(),p=Bu(i.fieldTransforms,l,a);return d.setAll(p),a.convertToFoundDocument(a.version,d).setHasLocalMutations(),null})(n,e,t,r):n instanceof qt?(function(i,a,c,l){if(!ys(i.precondition,a))return c;const d=Bu(i.fieldTransforms,l,a),p=a.data;return p.setAll(cd(i)),p.setAll(d),a.convertToFoundDocument(a.version,p).setHasLocalMutations(),c===null?null:c.unionWith(i.fieldMask.fields).unionWith(i.fieldTransforms.map((g=>g.field)))})(n,e,t,r):(function(i,a,c){return ys(i.precondition,a)?(a.convertToNoDocument(a.version).setHasLocalMutations(),null):c})(n,e,t)}function pv(n,e){let t=null;for(const r of n.fieldTransforms){const s=e.data.field(r.field),i=rd(r.transform,s||null);i!=null&&(t===null&&(t=De.empty()),t.set(r.field,i))}return t||null}function Uu(n,e){return n.type===e.type&&!!n.key.isEqual(e.key)&&!!n.precondition.isEqual(e.precondition)&&!!(function(r,s){return r===void 0&&s===void 0||!(!r||!s)&&bn(r,s,((i,a)=>hv(i,a)))})(n.fieldTransforms,e.fieldTransforms)&&(n.type===0?n.value.isEqual(e.value):n.type!==1||n.data.isEqual(e.data)&&n.fieldMask.isEqual(e.fieldMask))}class Vr extends ti{constructor(e,t,r,s=[]){super(),this.key=e,this.value=t,this.precondition=r,this.fieldTransforms=s,this.type=0}getFieldMask(){return null}}class qt extends ti{constructor(e,t,r,s,i=[]){super(),this.key=e,this.data=t,this.fieldMask=r,this.precondition=s,this.fieldTransforms=i,this.type=1}getFieldMask(){return this.fieldMask}}function cd(n){const e=new Map;return n.fieldMask.fields.forEach((t=>{if(!t.isEmpty()){const r=n.data.field(t);e.set(t,r)}})),e}function Fu(n,e,t){const r=new Map;Q(n.length===t.length,32656,{Ae:t.length,Re:n.length});for(let s=0;s<t.length;s++){const i=n[s],a=i.transform,c=e.data.field(i.field);r.set(i.field,uv(a,c,t[s]))}return r}function Bu(n,e,t){const r=new Map;for(const s of n){const i=s.transform,a=t.data.field(s.field);r.set(s.field,cv(i,a,e))}return r}class ud extends ti{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class mv extends ti{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fv{constructor(e){this.gt=e}}function Bv(n){const e=Vv({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?Vs(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jv{constructor(){this.Dn=new $v}addToCollectionParentIndex(e,t){return this.Dn.add(t),P.resolve()}getCollectionParents(e,t){return P.resolve(this.Dn.getEntries(t))}addFieldIndex(e,t){return P.resolve()}deleteFieldIndex(e,t){return P.resolve()}deleteAllFieldIndexes(e){return P.resolve()}createTargetIndexes(e,t){return P.resolve()}getDocumentsMatchingTarget(e,t){return P.resolve(null)}getIndexType(e,t){return P.resolve(0)}getFieldIndexes(e,t){return P.resolve([])}getNextCollectionGroupToUpdate(e){return P.resolve(null)}getMinOffset(e,t){return P.resolve(Dt.min())}getMinOffsetFromCollectionGroup(e,t){return P.resolve(Dt.min())}updateCollectionGroup(e,t,r){return P.resolve()}updateIndexEntries(e,t){return P.resolve()}}class $v{constructor(){this.index={}}add(e){const t=e.lastSegment(),r=e.popLast(),s=this.index[t]||new he(X.comparator),i=!s.has(r);return this.index[t]=s.add(r),i}has(e){const t=e.lastSegment(),r=e.popLast(),s=this.index[t];return s&&s.has(r)}getEntries(e){return(this.index[e]||new he(X.comparator)).toArray()}}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kv{constructor(){this.changes=new hn((e=>e.toString()),((e,t)=>e.isEqual(t))),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,Ae.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const r=this.changes.get(t);return r!==void 0?P.resolve(r):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xv{constructor(e){this.serializer=e,this.Br=new Map,this.Lr=new Map}getBundleMetadata(e,t){return P.resolve(this.Br.get(t))}saveBundleMetadata(e,t){return this.Br.set(t.id,(function(s){return{id:s.id,version:s.version,createTime:Ye(s.createTime)}})(t)),P.resolve()}getNamedQuery(e,t){return P.resolve(this.Lr.get(t))}saveNamedQuery(e,t){return this.Lr.set(t.name,(function(s){return{name:s.name,query:Bv(s.bundledQuery),readTime:Ye(s.readTime)}})(t)),P.resolve()}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zv{constructor(){this.sessionToken=_e.EMPTY_BYTE_STRING}getSessionToken(e){return P.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,P.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Td{constructor(e,t){this.ai={},this.overlays={},this.ui=new Qs(0),this.ci=!1,this.ci=!0,this.li=new Zv,this.referenceDelegate=e(this),this.hi=new rE(this),this.indexManager=new jv,this.remoteDocumentCache=(function(s){return new tE(s)})((r=>this.referenceDelegate.Pi(r))),this.serializer=new Fv(t),this.Ti=new Xv(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.ci=!1,Promise.resolve()}get started(){return this.ci}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new Yv,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let r=this.ai[e.toKey()];return r||(r=new eE(t,this.referenceDelegate),this.ai[e.toKey()]=r),r}getGlobalsCache(){return this.li}getTargetCache(){return this.hi}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Ti}runTransaction(e,t,r){O("MemoryPersistence","Starting transaction:",e);const s=new sE(this.ui.next());return this.referenceDelegate.Ii(),r(s).next((i=>this.referenceDelegate.di(s).next((()=>i)))).toPromise().then((i=>(s.raiseOnCommittedEvent(),i)))}Ei(e,t){return P.or(Object.values(this.ai).map((r=>()=>r.containsKey(e,t))))}}class sE extends Ny{constructor(e){super(),this.currentSequenceNumber=e}}class sa{constructor(e){this.persistence=e,this.Ai=new ra,this.Ri=null}static Vi(e){return new sa(e)}get mi(){if(this.Ri)return this.Ri;throw x(60996)}addReference(e,t,r){return this.Ai.addReference(r,t),this.mi.delete(r.toString()),P.resolve()}removeReference(e,t,r){return this.Ai.removeReference(r,t),this.mi.add(r.toString()),P.resolve()}markPotentiallyOrphaned(e,t){return this.mi.add(t.toString()),P.resolve()}removeTarget(e,t){this.Ai.zr(t.targetId).forEach((s=>this.mi.add(s.toString())));const r=this.persistence.getTargetCache();return r.getMatchingKeysForTargetId(e,t.targetId).next((s=>{s.forEach((i=>this.mi.add(i.toString())))})).next((()=>r.removeTargetData(e,t)))}Ii(){this.Ri=new Set}di(e){const t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return P.forEach(this.mi,(r=>{const s=L.fromPath(r);return this.fi(e,s).next((i=>{i||t.removeEntry(s,B.min())}))})).next((()=>(this.Ri=null,t.apply(e))))}updateLimboDocument(e,t){return this.fi(e,t).next((r=>{r?this.mi.delete(t.toString()):this.mi.add(t.toString())}))}Pi(e){return 0}fi(e,t){return P.or([()=>P.resolve(this.Ai.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.Ei(e,t)])}}class Ms{constructor(e,t){this.persistence=e,this.gi=new hn((r=>Ly(r.path)),((r,s)=>r.isEqual(s))),this.garbageCollector=Gv(this,t)}static Vi(e,t){return new Ms(e,t)}Ii(){}di(e){return P.resolve()}forEachTarget(e,t){return this.persistence.getTargetCache().forEachTarget(e,t)}mr(e){const t=this.yr(e);return this.persistence.getTargetCache().getTargetCount(e).next((r=>t.next((s=>r+s))))}yr(e){let t=0;return this.gr(e,(r=>{t++})).next((()=>t))}gr(e,t){return P.forEach(this.gi,((r,s)=>this.Sr(e,r,s).next((i=>i?P.resolve():t(s)))))}removeTargets(e,t,r){return this.persistence.getTargetCache().removeTargets(e,t,r)}removeOrphanedDocuments(e,t){let r=0;const s=this.persistence.getRemoteDocumentCache(),i=s.newChangeBuffer();return s.ri(e,(a=>this.Sr(e,a,t).next((c=>{c||(r++,i.removeEntry(a,B.min()))})))).next((()=>i.apply(e))).next((()=>r))}markPotentiallyOrphaned(e,t){return this.gi.set(t,e.currentSequenceNumber),P.resolve()}removeTarget(e,t){const r=t.withSequenceNumber(e.currentSequenceNumber);return this.persistence.getTargetCache().updateTargetData(e,r)}addReference(e,t,r){return this.gi.set(r,e.currentSequenceNumber),P.resolve()}removeReference(e,t,r){return this.gi.set(r,e.currentSequenceNumber),P.resolve()}updateLimboDocument(e,t){return this.gi.set(t,e.currentSequenceNumber),P.resolve()}Pi(e){let t=e.key.toString().length;return e.isFoundDocument()&&(t+=gs(e.data.value)),t}Sr(e,t,r){return P.or([()=>this.persistence.Ei(e,t),()=>this.persistence.getTargetCache().containsKey(e,t),()=>{const s=this.gi.get(t);return P.resolve(s!==void 0&&s>r)}])}getCacheSize(e){return this.persistence.getRemoteDocumentCache().getSize(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oE{constructor(){this.As=!1,this.Rs=!1,this.Vs=100,this.fs=(function(){return Bp()?8:Vy(Re())>0?6:4})()}initialize(e,t){this.gs=e,this.indexManager=t,this.As=!0}getDocumentsMatchingQuery(e,t,r,s){const i={result:null};return this.ps(e,t).next((a=>{i.result=a})).next((()=>{if(!i.result)return this.ys(e,t,s,r).next((a=>{i.result=a}))})).next((()=>{if(i.result)return;const a=new iE;return this.ws(e,t,a).next((c=>{if(i.result=c,this.Rs)return this.Ss(e,t,a,c.size)}))})).next((()=>i.result))}Ss(e,t,r,s){return r.documentReadCount<this.Vs?(_n()<=H.DEBUG&&O("QueryEngine","SDK will not create cache indexes for query:",yn(t),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),P.resolve()):(_n()<=H.DEBUG&&O("QueryEngine","Query:",yn(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.fs*s?(_n()<=H.DEBUG&&O("QueryEngine","The SDK decides to create cache indexes for query:",yn(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Xe(t))):P.resolve())}ps(e,t){if(Mu(t))return P.resolve(null);let r=Xe(t);return this.indexManager.getIndexType(e,r).next((s=>s===0?null:(t.limit!==null&&s===1&&(t=Vs(t,null,"F"),r=Xe(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next((i=>{const a=W(...i);return this.gs.getDocuments(e,a).next((c=>this.indexManager.getMinOffset(e,r).next((l=>{const d=this.bs(t,c);return this.Ds(t,d,a,l.readTime)?this.ps(e,Vs(t,null,"F")):this.vs(e,d,t,l)}))))})))))}ys(e,t,r,s){return Mu(t)||s.isEqual(B.min())?P.resolve(null):this.gs.getDocuments(e,r).next((i=>{const a=this.bs(t,i);return this.Ds(t,a,r,s)?P.resolve(null):(_n()<=H.DEBUG&&O("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),yn(t)),this.vs(e,a,t,Py(s,vr)).next((c=>c)))}))}bs(e,t){let r=new he(Yh(e));return t.forEach(((s,i)=>{Zs(e,i)&&(r=r.add(i))})),r}Ds(e,t,r,s){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const i=e.limitType==="F"?t.last():t.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}ws(e,t,r){return _n()<=H.DEBUG&&O("QueryEngine","Using full collection scan to execute query:",yn(t)),this.gs.getDocumentsMatchingQuery(e,t,Dt.min(),r)}vs(e,t,r,s){return this.gs.getDocumentsMatchingQuery(e,r,s).next((i=>(t.forEach((a=>{i=i.insert(a.key,a)})),i)))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ki="RestConnection",yE={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};class vE{get Qo(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.$o=t+"://"+e.host,this.Uo=`projects/${r}/databases/${s}`,this.Ko=this.databaseId.database===ks?`project_id=${r}`:`project_id=${r}&database_id=${s}`}Wo(e,t,r,s,i){const a=Ao(),c=this.Go(e,t.toUriEncodedString());O(Ki,`Sending RPC '${e}' ${a}:`,c,r);const l={"google-cloud-resource-prefix":this.Uo,"x-goog-request-params":this.Ko};this.zo(l,s,i);const{host:d}=new URL(c),p=xt(d);return this.jo(e,c,l,r,p).then((g=>(O(Ki,`Received RPC '${e}' ${a}: `,g),g)),(g=>{throw kt(Ki,`RPC '${e}' ${a} failed with error: `,g,"url: ",c,"request:",r),g}))}Jo(e,t,r,s,i,a){return this.Wo(e,t,r,s,i)}zo(e,t,r){e["X-Goog-Api-Client"]=(function(){return"gl-js/ fire/"+Nn})(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach(((s,i)=>e[i]=s)),r&&r.headers.forEach(((s,i)=>e[i]=s))}Go(e,t){const r=yE[e];return`${this.$o}/v1/${t}:${r}`}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ri(n){return new Rv(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sn="RemoteStore";class SE{constructor(e,t,r,s,i){this.localStore=e,this.datastore=t,this.asyncQueue=r,this.remoteSyncer={},this.Pa=[],this.Ta=new Map,this.Ia=new Set,this.da=[],this.Ea=i,this.Ea.xo((a=>{r.enqueueAndForget((async()=>{dn(this)&&(O(sn,"Restarting streams for network reachability change."),await(async function(l){const d=j(l);d.Ia.add(4),await Lr(d),d.Aa.set("Unknown"),d.Ia.delete(4),await si(d)})(this))}))})),this.Aa=new bE(r,s)}}async function si(n){if(dn(n))for(const e of n.da)await e(!0)}async function Lr(n){for(const e of n.da)await e(!1)}function bd(n,e){const t=j(n);t.Ta.has(e.targetId)||(t.Ta.set(e.targetId,e),la(t)?ua(t):Mn(t).x_()&&ca(t,e))}function aa(n,e){const t=j(n),r=Mn(t);t.Ta.delete(e),r.x_()&&Sd(t,e),t.Ta.size===0&&(r.x_()?r.B_():dn(t)&&t.Aa.set("Unknown"))}function ca(n,e){if(n.Ra.$e(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(B.min())>0){const t=n.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}Mn(n).H_(e)}function Sd(n,e){n.Ra.$e(e),Mn(n).Y_(e)}function ua(n){n.Ra=new Tv({getRemoteKeysForTarget:e=>n.remoteSyncer.getRemoteKeysForTarget(e),Et:e=>n.Ta.get(e)||null,lt:()=>n.datastore.serializer.databaseId}),Mn(n).start(),n.Aa.aa()}function la(n){return dn(n)&&!Mn(n).M_()&&n.Ta.size>0}function dn(n){return j(n).Ia.size===0}function Pd(n){n.Ra=void 0}async function PE(n){n.Aa.set("Online")}async function CE(n){n.Ta.forEach(((e,t)=>{ca(n,e)}))}async function kE(n,e){Pd(n),la(n)?(n.Aa.la(e),ua(n)):n.Aa.set("Unknown")}async function DE(n,e,t){if(n.Aa.set("Online"),e instanceof dd&&e.state===2&&e.cause)try{await(async function(s,i){const a=i.cause;for(const c of i.targetIds)s.Ta.has(c)&&(await s.remoteSyncer.rejectListen(c,a),s.Ta.delete(c),s.Ra.removeTarget(c))})(n,e)}catch(r){O(sn,"Failed to remove targets %s: %s ",e.targetIds.join(","),r),await xs(n,r)}else if(e instanceof vs?n.Ra.Ye(e):e instanceof hd?n.Ra.it(e):n.Ra.et(e),!t.isEqual(B.min()))try{const r=await wd(n.localStore);t.compareTo(r)>=0&&await(function(i,a){const c=i.Ra.Pt(a);return c.targetChanges.forEach(((l,d)=>{if(l.resumeToken.approximateByteSize()>0){const p=i.Ta.get(d);p&&i.Ta.set(d,p.withResumeToken(l.resumeToken,a))}})),c.targetMismatches.forEach(((l,d)=>{const p=i.Ta.get(l);if(!p)return;i.Ta.set(l,p.withResumeToken(_e.EMPTY_BYTE_STRING,p.snapshotVersion)),Sd(i,l);const g=new At(p.target,l,d,p.sequenceNumber);ca(i,g)})),i.remoteSyncer.applyRemoteEvent(c)})(n,t)}catch(r){O(sn,"Failed to raise snapshot:",r),await xs(n,r)}}async function xs(n,e,t){if(!On(e))throw e;n.Ia.add(1),await Lr(n),n.Aa.set("Offline"),t||(t=()=>wd(n.localStore)),n.asyncQueue.enqueueRetryable((async()=>{O(sn,"Retrying IndexedDB access"),await t(),n.Ia.delete(1),await si(n)}))}function Cd(n,e){return e().catch((t=>xs(n,t,e)))}async function ii(n){const e=j(n),t=Lt(e);let r=e.Pa.length>0?e.Pa[e.Pa.length-1].batchId:Go;for(;NE(e);)try{const s=await fE(e.localStore,r);if(s===null){e.Pa.length===0&&t.B_();break}r=s.batchId,VE(e,s)}catch(s){await xs(e,s)}kd(e)&&Dd(e)}function NE(n){return dn(n)&&n.Pa.length<10}function VE(n,e){n.Pa.push(e);const t=Lt(n);t.x_()&&t.Z_&&t.X_(e.mutations)}function kd(n){return dn(n)&&!Lt(n).M_()&&n.Pa.length>0}function Dd(n){Lt(n).start()}async function OE(n){Lt(n).na()}async function LE(n){const e=Lt(n);for(const t of n.Pa)e.X_(t.mutations)}async function ME(n,e,t){const r=n.Pa.shift(),s=ea.from(r,e,t);await Cd(n,(()=>n.remoteSyncer.applySuccessfulWrite(s))),await ii(n)}async function xE(n,e){e&&Lt(n).Z_&&await(async function(r,s){if((function(a){return vv(a)&&a!==S.ABORTED})(s.code)){const i=r.Pa.shift();Lt(r).N_(),await Cd(r,(()=>r.remoteSyncer.rejectFailedWrite(i.batchId,s))),await ii(r)}})(n,e),kd(n)&&Dd(n)}async function el(n,e){const t=j(n);t.asyncQueue.verifyOperationInProgress(),O(sn,"RemoteStore received new credentials");const r=dn(t);t.Ia.add(3),await Lr(t),r&&t.Aa.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ia.delete(3),await si(t)}async function UE(n,e){const t=j(n);e?(t.Ia.delete(2),await si(t)):e||(t.Ia.add(2),await Lr(t),t.Aa.set("Unknown"))}function Mn(n){return n.Va||(n.Va=(function(t,r,s){const i=j(t);return i.ia(),new IE(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)})(n.datastore,n.asyncQueue,{Zo:PE.bind(null,n),e_:CE.bind(null,n),n_:kE.bind(null,n),J_:DE.bind(null,n)}),n.da.push((async e=>{e?(n.Va.N_(),la(n)?ua(n):n.Aa.set("Unknown")):(await n.Va.stop(),Pd(n))}))),n.Va}function Lt(n){return n.ma||(n.ma=(function(t,r,s){const i=j(t);return i.ia(),new wE(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)})(n.datastore,n.asyncQueue,{Zo:()=>Promise.resolve(),e_:OE.bind(null,n),n_:xE.bind(null,n),ea:LE.bind(null,n),ta:ME.bind(null,n)}),n.da.push((async e=>{e?(n.ma.N_(),await ii(n)):(await n.ma.stop(),n.Pa.length>0&&(O(sn,`Stopping write stream with ${n.Pa.length} pending writes`),n.Pa=[]))}))),n.ma}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ld{constructor(e){this.key=e}}class Md{constructor(e){this.key=e}}class qE{constructor(e,t){this.query=e,this.Ha=t,this.Ya=null,this.hasCachedResults=!1,this.current=!1,this.Za=W(),this.mutatedKeys=W(),this.Xa=Yh(e),this.eu=new An(this.Xa)}get tu(){return this.Ha}nu(e,t){const r=t?t.ru:new tl,s=t?t.eu:this.eu;let i=t?t.mutatedKeys:this.mutatedKeys,a=s,c=!1;const l=this.query.limitType==="F"&&s.size===this.query.limit?s.last():null,d=this.query.limitType==="L"&&s.size===this.query.limit?s.first():null;if(e.inorderTraversal(((p,g)=>{const v=s.get(p),b=Zs(this.query,g)?g:null,C=!!v&&this.mutatedKeys.has(v.key),V=!!b&&(b.hasLocalMutations||this.mutatedKeys.has(b.key)&&b.hasCommittedMutations);let k=!1;v&&b?v.data.isEqual(b.data)?C!==V&&(r.track({type:3,doc:b}),k=!0):this.iu(v,b)||(r.track({type:2,doc:b}),k=!0,(l&&this.Xa(b,l)>0||d&&this.Xa(b,d)<0)&&(c=!0)):!v&&b?(r.track({type:0,doc:b}),k=!0):v&&!b&&(r.track({type:1,doc:v}),k=!0,(l||d)&&(c=!0)),k&&(b?(a=a.add(b),i=V?i.add(p):i.delete(p)):(a=a.delete(p),i=i.delete(p)))})),this.query.limit!==null)for(;a.size>this.query.limit;){const p=this.query.limitType==="F"?a.last():a.first();a=a.delete(p.key),i=i.delete(p.key),r.track({type:1,doc:p})}return{eu:a,ru:r,Ds:c,mutatedKeys:i}}iu(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,r,s){const i=this.eu;this.eu=e.eu,this.mutatedKeys=e.mutatedKeys;const a=e.ru.pa();a.sort(((p,g)=>(function(b,C){const V=k=>{switch(k){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return x(20277,{At:k})}};return V(b)-V(C)})(p.type,g.type)||this.Xa(p.doc,g.doc))),this.su(r),s=s!=null&&s;const c=t&&!s?this.ou():[],l=this.Za.size===0&&this.current&&!s?1:0,d=l!==this.Ya;return this.Ya=l,a.length!==0||d?{snapshot:new kn(this.query,e.eu,i,a,e.mutatedKeys,l===0,d,!1,!!r&&r.resumeToken.approximateByteSize()>0),_u:c}:{_u:c}}va(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({eu:this.eu,ru:new tl,mutatedKeys:this.mutatedKeys,Ds:!1},!1)):{_u:[]}}au(e){return!this.Ha.has(e)&&!!this.eu.has(e)&&!this.eu.get(e).hasLocalMutations}su(e){e&&(e.addedDocuments.forEach((t=>this.Ha=this.Ha.add(t))),e.modifiedDocuments.forEach((t=>{})),e.removedDocuments.forEach((t=>this.Ha=this.Ha.delete(t))),this.current=e.current)}ou(){if(!this.current)return[];const e=this.Za;this.Za=W(),this.eu.forEach((r=>{this.au(r.key)&&(this.Za=this.Za.add(r.key))}));const t=[];return e.forEach((r=>{this.Za.has(r)||t.push(new Md(r))})),this.Za.forEach((r=>{e.has(r)||t.push(new Ld(r))})),t}uu(e){this.Ha=e.qs,this.Za=W();const t=this.nu(e.documents);return this.applyChanges(t,!0)}cu(){return kn.fromInitialDocuments(this.query,this.eu,this.mutatedKeys,this.Ya===0,this.hasCachedResults)}}const pa="SyncEngine";class zE{constructor(e,t,r){this.query=e,this.targetId=t,this.view=r}}class HE{constructor(e){this.key=e,this.lu=!1}}class WE{constructor(e,t,r,s,i,a){this.localStore=e,this.remoteStore=t,this.eventManager=r,this.sharedClientState=s,this.currentUser=i,this.maxConcurrentLimboResolutions=a,this.hu={},this.Pu=new hn((c=>Xh(c)),Ys),this.Tu=new Map,this.Iu=new Set,this.du=new ne(L.comparator),this.Eu=new Map,this.Au=new ra,this.Ru={},this.Vu=new Map,this.mu=Cn.ur(),this.onlineState="Unknown",this.fu=void 0}get isPrimaryClient(){return this.fu===!0}}async function GE(n,e,t=!0){const r=$d(n);let s;const i=r.Pu.get(e);return i?(r.sharedClientState.addLocalQueryTarget(i.targetId),s=i.view.cu()):s=await xd(r,e,t,!0),s}async function KE(n,e){const t=$d(n);await xd(t,e,!0,!1)}async function xd(n,e,t,r){const s=await pE(n.localStore,Xe(e)),i=s.targetId,a=n.sharedClientState.addLocalQueryTarget(i,t);let c;return r&&(c=await QE(n,e,i,a==="current",s.resumeToken)),n.isPrimaryClient&&t&&bd(n.remoteStore,s),c}async function QE(n,e,t,r,s){n.gu=(g,v,b)=>(async function(V,k,$,U){let F=k.view.nu($);F.Ds&&(F=await Qu(V.localStore,k.query,!1).then((({documents:T})=>k.view.nu(T,F))));const z=U&&U.targetChanges.get(k.targetId),fe=U&&U.targetMismatches.get(k.targetId)!=null,Y=k.view.applyChanges(F,V.isPrimaryClient,z,fe);return il(V,k.targetId,Y._u),Y.snapshot})(n,g,v,b);const i=await Qu(n.localStore,e,!0),a=new qE(e,i.qs),c=a.nu(i.documents),l=Or.createSynthesizedTargetChangeForCurrentChange(t,r&&n.onlineState!=="Offline",s),d=a.applyChanges(c,n.isPrimaryClient,l);il(n,t,d._u);const p=new zE(e,t,a);return n.Pu.set(e,p),n.Tu.has(t)?n.Tu.get(t).push(e):n.Tu.set(t,[e]),d.snapshot}async function JE(n,e,t){const r=j(n),s=r.Pu.get(e),i=r.Tu.get(s.targetId);if(i.length>1)return r.Tu.set(s.targetId,i.filter((a=>!Ys(a,e)))),void r.Pu.delete(e);r.isPrimaryClient?(r.sharedClientState.removeLocalQueryTarget(s.targetId),r.sharedClientState.isActiveQueryTarget(s.targetId)||await wo(r.localStore,s.targetId,!1).then((()=>{r.sharedClientState.clearQueryState(s.targetId),t&&aa(r.remoteStore,s.targetId),bo(r,s.targetId)})).catch(Vn)):(bo(r,s.targetId),await wo(r.localStore,s.targetId,!0))}async function XE(n,e){const t=j(n),r=t.Pu.get(e),s=t.Tu.get(r.targetId);t.isPrimaryClient&&s.length===1&&(t.sharedClientState.removeLocalQueryTarget(r.targetId),aa(t.remoteStore,r.targetId))}async function YE(n,e,t){const r=iT(n);try{const s=await(function(a,c){const l=j(a),d=ee.now(),p=c.reduce(((b,C)=>b.add(C.key)),W());let g,v;return l.persistence.runTransaction("Locally write mutations","readwrite",(b=>{let C=ft(),V=W();return l.Os.getEntries(b,p).next((k=>{C=k,C.forEach((($,U)=>{U.isValidDocument()||(V=V.add($))}))})).next((()=>l.localDocuments.getOverlayedDocuments(b,C))).next((k=>{g=k;const $=[];for(const U of c){const F=pv(U,g.get(U.key).overlayedDocument);F!=null&&$.push(new qt(U.key,F,qh(F.value.mapValue),He.exists(!0)))}return l.mutationQueue.addMutationBatch(b,d,$,c)})).next((k=>{v=k;const $=k.applyToLocalDocumentSet(g,V);return l.documentOverlayCache.saveOverlays(b,k.batchId,$)}))})).then((()=>({batchId:v.batchId,changes:ed(g)})))})(r.localStore,e);r.sharedClientState.addPendingMutation(s.batchId),(function(a,c,l){let d=a.Ru[a.currentUser.toKey()];d||(d=new ne(q)),d=d.insert(c,l),a.Ru[a.currentUser.toKey()]=d})(r,s.batchId,t),await Mr(r,s.changes),await ii(r.remoteStore)}catch(s){const i=da(s,"Failed to persist write");t.reject(i)}}async function Ud(n,e){const t=j(n);try{const r=await hE(t.localStore,e);e.targetChanges.forEach(((s,i)=>{const a=t.Eu.get(i);a&&(Q(s.addedDocuments.size+s.modifiedDocuments.size+s.removedDocuments.size<=1,22616),s.addedDocuments.size>0?a.lu=!0:s.modifiedDocuments.size>0?Q(a.lu,14607):s.removedDocuments.size>0&&(Q(a.lu,42227),a.lu=!1))})),await Mr(t,r,e)}catch(r){await Vn(r)}}function sl(n,e,t){const r=j(n);if(r.isPrimaryClient&&t===0||!r.isPrimaryClient&&t===1){const s=[];r.Pu.forEach(((i,a)=>{const c=a.view.va(e);c.snapshot&&s.push(c.snapshot)})),(function(a,c){const l=j(a);l.onlineState=c;let d=!1;l.queries.forEach(((p,g)=>{for(const v of g.wa)v.va(c)&&(d=!0)})),d&&fa(l)})(r.eventManager,e),s.length&&r.hu.J_(s),r.onlineState=e,r.isPrimaryClient&&r.sharedClientState.setOnlineState(e)}}async function ZE(n,e,t){const r=j(n);r.sharedClientState.updateQueryState(e,"rejected",t);const s=r.Eu.get(e),i=s&&s.key;if(i){let a=new ne(L.comparator);a=a.insert(i,Ae.newNoDocument(i,B.min()));const c=W().add(i),l=new ni(B.min(),new Map,new ne(q),a,c);await Ud(r,l),r.du=r.du.remove(i),r.Eu.delete(e),ma(r)}else await wo(r.localStore,e,!1).then((()=>bo(r,e,t))).catch(Vn)}async function eT(n,e){const t=j(n),r=e.batch.batchId;try{const s=await lE(t.localStore,e);Bd(t,r,null),Fd(t,r),t.sharedClientState.updateMutationState(r,"acknowledged"),await Mr(t,s)}catch(s){await Vn(s)}}async function tT(n,e,t){const r=j(n);try{const s=await(function(a,c){const l=j(a);return l.persistence.runTransaction("Reject batch","readwrite-primary",(d=>{let p;return l.mutationQueue.lookupMutationBatch(d,c).next((g=>(Q(g!==null,37113),p=g.keys(),l.mutationQueue.removeMutationBatch(d,g)))).next((()=>l.mutationQueue.performConsistencyCheck(d))).next((()=>l.documentOverlayCache.removeOverlaysForBatchId(d,p,c))).next((()=>l.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(d,p))).next((()=>l.localDocuments.getDocuments(d,p)))}))})(r.localStore,e);Bd(r,e,t),Fd(r,e),r.sharedClientState.updateMutationState(e,"rejected",t),await Mr(r,s)}catch(s){await Vn(s)}}function Fd(n,e){(n.Vu.get(e)||[]).forEach((t=>{t.resolve()})),n.Vu.delete(e)}function Bd(n,e,t){const r=j(n);let s=r.Ru[r.currentUser.toKey()];if(s){const i=s.get(e);i&&(t?i.reject(t):i.resolve(),s=s.remove(e)),r.Ru[r.currentUser.toKey()]=s}}function bo(n,e,t=null){n.sharedClientState.removeLocalQueryTarget(e);for(const r of n.Tu.get(e))n.Pu.delete(r),t&&n.hu.pu(r,t);n.Tu.delete(e),n.isPrimaryClient&&n.Au.zr(e).forEach((r=>{n.Au.containsKey(r)||jd(n,r)}))}function jd(n,e){n.Iu.delete(e.path.canonicalString());const t=n.du.get(e);t!==null&&(aa(n.remoteStore,t),n.du=n.du.remove(e),n.Eu.delete(t),ma(n))}function il(n,e,t){for(const r of t)r instanceof Ld?(n.Au.addReference(r.key,e),nT(n,r)):r instanceof Md?(O(pa,"Document no longer in limbo: "+r.key),n.Au.removeReference(r.key,e),n.Au.containsKey(r.key)||jd(n,r.key)):x(19791,{yu:r})}function nT(n,e){const t=e.key,r=t.path.canonicalString();n.du.get(t)||n.Iu.has(r)||(O(pa,"New document in limbo: "+t),n.Iu.add(r),ma(n))}function ma(n){for(;n.Iu.size>0&&n.du.size<n.maxConcurrentLimboResolutions;){const e=n.Iu.values().next().value;n.Iu.delete(e);const t=new L(X.fromString(e)),r=n.mu.next();n.Eu.set(r,new HE(t)),n.du=n.du.insert(t,r),bd(n.remoteStore,new At(Xe(Yo(t.path)),r,"TargetPurposeLimboResolution",Qs.ue))}}async function Mr(n,e,t){const r=j(n),s=[],i=[],a=[];r.Pu.isEmpty()||(r.Pu.forEach(((c,l)=>{a.push(r.gu(l,e,t).then((d=>{var p;if((d||t)&&r.isPrimaryClient){const g=d?!d.fromCache:(p=t==null?void 0:t.targetChanges.get(l.targetId))===null||p===void 0?void 0:p.current;r.sharedClientState.updateQueryState(l.targetId,g?"current":"not-current")}if(d){s.push(d);const g=ia.Es(l.targetId,d);i.push(g)}})))})),await Promise.all(a),r.hu.J_(s),await(async function(l,d){const p=j(l);try{await p.persistence.runTransaction("notifyLocalViewChanges","readwrite",(g=>P.forEach(d,(v=>P.forEach(v.Is,(b=>p.persistence.referenceDelegate.addReference(g,v.targetId,b))).next((()=>P.forEach(v.ds,(b=>p.persistence.referenceDelegate.removeReference(g,v.targetId,b)))))))))}catch(g){if(!On(g))throw g;O(oa,"Failed to update sequence numbers: "+g)}for(const g of d){const v=g.targetId;if(!g.fromCache){const b=p.Fs.get(v),C=b.snapshotVersion,V=b.withLastLimboFreeSnapshotVersion(C);p.Fs=p.Fs.insert(v,V)}}})(r.localStore,i))}async function rT(n,e){const t=j(n);if(!t.currentUser.isEqual(e)){O(pa,"User change. New user:",e.toKey());const r=await Id(t.localStore,e);t.currentUser=e,(function(i,a){i.Vu.forEach((c=>{c.forEach((l=>{l.reject(new N(S.CANCELLED,a))}))})),i.Vu.clear()})(t,"'waitForPendingWrites' promise is rejected due to a user change."),t.sharedClientState.handleUserChange(e,r.removedBatchIds,r.addedBatchIds),await Mr(t,r.Bs)}}function sT(n,e){const t=j(n),r=t.Eu.get(e);if(r&&r.lu)return W().add(r.key);{let s=W();const i=t.Tu.get(e);if(!i)return s;for(const a of i){const c=t.Pu.get(a);s=s.unionWith(c.view.tu)}return s}}function $d(n){const e=j(n);return e.remoteStore.remoteSyncer.applyRemoteEvent=Ud.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=sT.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=ZE.bind(null,e),e.hu.J_=jE.bind(null,e.eventManager),e.hu.pu=$E.bind(null,e.eventManager),e}function iT(n){const e=j(n);return e.remoteStore.remoteSyncer.applySuccessfulWrite=eT.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=tT.bind(null,e),e}class Us{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=ri(e.databaseInfo.databaseId),this.sharedClientState=this.bu(e),this.persistence=this.Du(e),await this.persistence.start(),this.localStore=this.vu(e),this.gcScheduler=this.Cu(e,this.localStore),this.indexBackfillerScheduler=this.Fu(e,this.localStore)}Cu(e,t){return null}Fu(e,t){return null}vu(e){return uE(this.persistence,new oE,e.initialUser,this.serializer)}Du(e){return new Td(sa.Vi,this.serializer)}bu(e){return new gE}async terminate(){var e,t;(e=this.gcScheduler)===null||e===void 0||e.stop(),(t=this.indexBackfillerScheduler)===null||t===void 0||t.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}Us.provider={build:()=>new Us};class oT extends Us{constructor(e){super(),this.cacheSizeBytes=e}Cu(e,t){Q(this.persistence.referenceDelegate instanceof Ms,46915);const r=this.persistence.referenceDelegate.garbageCollector;return new Hv(r,e.asyncQueue,t)}Du(e){const t=this.cacheSizeBytes!==void 0?Ce.withCacheSize(this.cacheSizeBytes):Ce.DEFAULT;return new Td((r=>Ms.Vi(r,t)),this.serializer)}}class So{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=r=>sl(this.syncEngine,r,1),this.remoteStore.remoteSyncer.handleCredentialChange=rT.bind(null,this.syncEngine),await UE(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return(function(){return new BE})()}createDatastore(e){const t=ri(e.databaseInfo.databaseId),r=(function(i){return new TE(i)})(e.databaseInfo);return(function(i,a,c,l){return new RE(i,a,c,l)})(e.authCredentials,e.appCheckCredentials,r,t)}createRemoteStore(e){return(function(r,s,i,a,c){return new SE(r,s,i,a,c)})(this.localStore,this.datastore,e.asyncQueue,(t=>sl(this.syncEngine,t,0)),(function(){return Yu.C()?new Yu:new _E})())}createSyncEngine(e,t){return(function(s,i,a,c,l,d,p){const g=new WE(s,i,a,c,l,d);return p&&(g.fu=!0),g})(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}async terminate(){var e,t;await(async function(s){const i=j(s);O(sn,"RemoteStore shutting down."),i.Ia.add(5),await Lr(i),i.Ea.shutdown(),i.Aa.set("Unknown")})(this.remoteStore),(e=this.datastore)===null||e===void 0||e.terminate(),(t=this.eventManager)===null||t===void 0||t.terminate()}}So.provider={build:()=>new So};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`+n.stack),e}class xn extends oi{constructor(e,t,r,s){super(e,t,r,s),this.type="firestore",this._queue=new hl,this._persistenceKey=(s==null?void 0:s.name)||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const e=this._firestoreClient.terminate();this._queue=new hl(e),this._firestoreClient=void 0,await e}}}function dA(n,e){const t=typeof n=="object"?n:zs(),r=typeof n=="string"?n:ks,s=Ut(t,"firestore").getImmediate({identifier:r});if(!s._initialized){const i=Nl("firestore");i&&dT(s,...i)}return s}function ga(n){if(n._terminated)throw new N(S.FAILED_PRECONDITION,"The client has already been terminated.");return n._firestoreClient||pT(n),n._firestoreClient}function pT(n){var e,t,r;const s=n._freezeSettings(),i=(function(c,l,d,p){return new Uy(c,l,d,p.host,p.ssl,p.experimentalForceLongPolling,p.experimentalAutoDetectLongPolling,Wd(p.experimentalLongPollingOptions),p.useFetchStreams,p.isUsingEmulator)})(n._databaseId,((e=n._app)===null||e===void 0?void 0:e.options.appId)||"",n._persistenceKey,s);n._componentsProvider||!((t=s.localCache)===null||t===void 0)&&t._offlineComponentProvider&&(!((r=s.localCache)===null||r===void 0)&&r._onlineComponentProvider)&&(n._componentsProvider={_offline:s.localCache._offlineComponentProvider,_online:s.localCache._onlineComponentProvider}),n._firestoreClient=new aT(n._authCredentials,n._appCheckCredentials,n._queue,i,n._componentsProvider&&(function(c){const l=c==null?void 0:c._online.build();return{_offline:c==null?void 0:c._offline.build(l),_online:l}})(n._componentsProvider))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _A(n){n=tt(n,ae);const e=tt(n.firestore,xn);return lT(ga(e),n._key).then((t=>bT(e,n,t)))}Rn._jsonSchemaVersion="firestore/querySnapshot/1.0",Rn._jsonSchema={type:le("string",Rn._jsonSchemaVersion),bundleSource:le("string","QuerySnapshot"),bundleName:le("string"),bundle:le("string")};class rf extends AT{constructor(e){super(),this.firestore=e}convertBytes(e){return new Ue(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new ae(this.firestore,null,t)}}function yA(n){n=tt(n,zt);const e=tt(n.firestore,xn),t=ga(e),r=new rf(e);return wT(n._query),hT(t,n._query).then((s=>new Rn(e,r,n,s)))}function vA(n,e,t){n=tt(n,ae);const r=tt(n.firestore,xn),s=nf(n.converter,e);return ba(r,[Jd(ui(r),"setDoc",n._key,s,n.converter!==null,t).toMutation(n._key,He.none())])}function EA(n,e,t,...r){n=tt(n,ae);const s=tt(n.firestore,xn),i=ui(s);let a;return a=typeof(e=te(e))=="string"||e instanceof ai?vT(i,"updateDoc",n._key,e,t,r):yT(i,"updateDoc",n._key,e),ba(s,[a.toMutation(n._key,He.exists(!0))])}function TA(n,e){const t=tt(n.firestore,xn),r=fT(n),s=nf(n.converter,e);return ba(t,[Jd(ui(n.firestore),"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,He.exists(!1))]).then((()=>r))}function ba(n,e){return(function(r,s){const i=new ut;return r.asyncQueue.enqueueAndForget((async()=>YE(await uT(r),s,i))),i.promise})(ga(n),e)}function bT(n,e,t){const r=t.docs.get(e._key),s=new rf(n);return new Zt(n,s,e._key,r,new ar(t.hasPendingWrites,t.fromCache),e.converter)}function IA(){return new ya("serverTimestamp")}(function(e,t=!0){(function(s){Nn=s})(ln),We(new Fe("firestore",((r,{instanceIdentifier:s,options:i})=>{const a=r.getProvider("app").getImmediate(),c=new xn(new vy(r.getProvider("auth-internal")),new Iy(a,r.getProvider("app-check-internal")),(function(d,p){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new N(S.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Tr(d.options.projectId,p)})(a,s),a);return i=Object.assign({useFetchStreams:t},i),c._setSettings(i),c}),"PUBLIC").setMultipleInstances(!0)),Ne(gu,_u,e),Ne(gu,_u,"esm2017")})();var ST="firebase",PT="11.10.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sf="firebasestorage.googleapis.com",of="storageBucket",CT=120*1e3,kT=600*1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function WT(n,e,t){let r=1,s=null,i=null,a=!1,c=0;function l(){return c===2}let d=!1;function p(...k){d||(d=!0,e.apply(null,k))}function g(k){s=setTimeout(()=>{s=null,n(b,l())},k)}function v(){i&&clearTimeout(i)}function b(k,...$){if(d){v();return}if(k){v(),p.call(null,k,...$);return}if(l()||a){v(),p.call(null,k,...$);return}r<64&&(r*=2);let F;c===1?(c=2,F=0):F=(r+Math.random())*1e3,g(F)}let C=!1;function V(k){C||(C=!0,v(),!d&&(s!==null?(k||(c=2),clearTimeout(s),g(0)):k||(c=1)))}return g(0),i=setTimeout(()=>{a=!0,V(!0)},t),V}function GT(n){n(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class XT{constructor(e,t,r,s,i,a,c,l,d,p,g,v=!0,b=!1){this.url_=e,this.method_=t,this.headers_=r,this.body_=s,this.successCodes_=i,this.additionalRetryCodes_=a,this.callback_=c,this.errorCallback_=l,this.timeout_=d,this.progressCallback_=p,this.connectionFactory_=g,this.retry=v,this.isUsingEmulator=b,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((C,V)=>{this.resolve_=C,this.reject_=V,this.start_()})}start_(){const e=(r,s)=>{if(s){r(!1,new us(!1,null,!0));return}const i=this.connectionFactory_();this.pendingConnection_=i;const a=c=>{const l=c.loaded,d=c.lengthComputable?c.total:-1;this.progressCallback_!==null&&this.progressCallback_(l,d)};this.progressCallback_!==null&&i.addUploadProgressListener(a),i.send(this.url_,this.method_,this.isUsingEmulator,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&i.removeUploadProgressListener(a),this.pendingConnection_=null;const c=i.getErrorCode()===en.NO_ERROR,l=i.getStatus();if(!c||JT(l,this.additionalRetryCodes_)&&this.retry){const p=i.getErrorCode()===en.ABORT;r(!1,new us(!1,null,p));return}const d=this.successCodes_.indexOf(l)!==-1;r(!0,new us(d,i))})},t=(r,s)=>{const i=this.resolve_,a=this.reject_,c=s.connection;if(s.wasSuccessCode)try{const l=this.callback_(c,c.getResponse());KT(l)?i(l):i()}catch(l){a(l)}else if(c!==null){const l=Sa();l.serverResponse=c.getErrorText(),this.errorCallback_?a(this.errorCallback_(c,l)):a(l)}else if(s.canceled){const l=this.appDelete_?af():xT();a(l)}else{const l=MT();a(l)}};this.canceled_?t(!1,new us(!1,null,!0)):this.backoffId_=WT(e,t,this.timeout_)}getPromise(){return this.promise_}cancel(e){this.canceled_=!0,this.appDelete_=e||!1,this.backoffId_!==null&&GT(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}}class us{constructor(e,t,r){this.wasSuccessCode=e,this.connection=t,this.canceled=!!r}}function YT(n,e){e!==null&&e.length>0&&(n.Authorization="Firebase "+e)}function ZT(n,e){n["X-Firebase-Storage-Version"]="webjs/"+(e??"AppManager")}function eI(n,e){e&&(n["X-Firebase-GMPID"]=e)}function tI(n,e){e!==null&&(n["X-Firebase-AppCheck"]=e)}function nI(n,e,t,r,s,i,a=!0,c=!1){const l=cf(n.urlParams),d=n.url+l,p=Object.assign({},n.headers);return eI(p,e),YT(p,t),ZT(p,i),tI(p,r),new XT(d,n.method,p,n.body,n.successCodes,n.additionalRetryCodes,n.handler,n.errorHandler,n.timeout,n.progressCallback,s,a,c)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oI(n){if(typeof atob>"u")throw qT("base-64");return atob(n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qe={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class Yi{constructor(e,t){this.data=e,this.contentType=t||null}}function aI(n,e){switch(n){case Qe.RAW:return new Yi(uf(e));case Qe.BASE64:case Qe.BASE64URL:return new Yi(lf(n,e));case Qe.DATA_URL:return new Yi(uI(e),lI(e))}throw Sa()}function uf(n){const e=[];for(let t=0;t<n.length;t++){let r=n.charCodeAt(t);if(r<=127)e.push(r);else if(r<=2047)e.push(192|r>>6,128|r&63);else if((r&64512)===55296)if(!(t<n.length-1&&(n.charCodeAt(t+1)&64512)===56320))e.push(239,191,189);else{const i=r,a=n.charCodeAt(++t);r=65536|(i&1023)<<10|a&1023,e.push(240|r>>18,128|r>>12&63,128|r>>6&63,128|r&63)}else(r&64512)===56320?e.push(239,191,189):e.push(224|r>>12,128|r>>6&63,128|r&63)}return new Uint8Array(e)}function cI(n){let e;try{e=decodeURIComponent(n)}catch{throw pr(Qe.DATA_URL,"Malformed data URL.")}return uf(e)}function lf(n,e){switch(n){case Qe.BASE64:{const s=e.indexOf("-")!==-1,i=e.indexOf("_")!==-1;if(s||i)throw pr(n,"Invalid character '"+(s?"-":"_")+"' found: is it base64url encoded?");break}case Qe.BASE64URL:{const s=e.indexOf("+")!==-1,i=e.indexOf("/")!==-1;if(s||i)throw pr(n,"Invalid character '"+(s?"+":"/")+"' found: is it base64 encoded?");e=e.replace(/-/g,"+").replace(/_/g,"/");break}}let t;try{t=oI(e)}catch(s){throw s.message.includes("polyfill")?s:pr(n,"Invalid character found")}const r=new Uint8Array(t.length);for(let s=0;s<t.length;s++)r[s]=t.charCodeAt(s);return r}class hf{constructor(e){this.base64=!1,this.contentType=null;const t=e.match(/^data:([^,]+)?,/);if(t===null)throw pr(Qe.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const r=t[1]||null;r!=null&&(this.base64=hI(r,";base64"),this.contentType=this.base64?r.substring(0,r.length-7):r),this.rest=e.substring(e.indexOf(",")+1)}}function uI(n){const e=new hf(n);return e.base64?lf(Qe.BASE64,e.rest):cI(e.rest)}function lI(n){return new hf(n).contentType}function hI(n,e){return n.length>=e.length?n.substring(n.length-e.length)===e:!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function df(n){let e;try{e=JSON.parse(n)}catch{return null}return QT(e)?e:null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dI(n){if(n.length===0)return null;const e=n.lastIndexOf("/");return e===-1?"":n.slice(0,e)}function fI(n,e){const t=e.split("/").filter(r=>r.length>0).join("/");return n.length===0?t:n+"/"+t}function ff(n){const e=n.lastIndexOf("/",n.length-2);return e===-1?n:n.slice(e+1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pI(n,e){return e}class Pe{constructor(e,t,r,s){this.server=e,this.local=t||e,this.writable=!!r,this.xform=s||pI}}let ls=null;function mI(n){return!Pa(n)||n.length<2?n:ff(n)}function pf(){if(ls)return ls;const n=[];n.push(new Pe("bucket")),n.push(new Pe("generation")),n.push(new Pe("metageneration")),n.push(new Pe("name","fullPath",!0));function e(i,a){return mI(a)}const t=new Pe("name");t.xform=e,n.push(t);function r(i,a){return a!==void 0?Number(a):a}const s=new Pe("size");return s.xform=r,n.push(s),n.push(new Pe("timeCreated")),n.push(new Pe("updated")),n.push(new Pe("md5Hash",null,!0)),n.push(new Pe("cacheControl",null,!0)),n.push(new Pe("contentDisposition",null,!0)),n.push(new Pe("contentEncoding",null,!0)),n.push(new Pe("contentLanguage",null,!0)),n.push(new Pe("contentType",null,!0)),n.push(new Pe("metadata","customMetadata",!0)),ls=n,ls}function gI(n,e){function t(){const r=n.bucket,s=n.fullPath,i=new Me(r,s);return e._makeStorageReference(i)}Object.defineProperty(n,"ref",{get:t})}function _I(n,e,t){const r={};r.type="file";const s=t.length;for(let i=0;i<s;i++){const a=t[i];r[a.local]=a.xform(r,e[a.server])}return gI(r,n),r}function mf(n,e,t){const r=df(e);return r===null?null:_I(n,r,t)}function yI(n,e,t,r){const s=df(e);if(s===null||!Pa(s.downloadTokens))return null;const i=s.downloadTokens;if(i.length===0)return null;const a=encodeURIComponent;return i.split(",").map(d=>{const p=n.bucket,g=n.fullPath,v="/b/"+a(p)+"/o/"+a(g),b=fi(v,t,r),C=cf({alt:"media",token:d});return b+C})[0]}function vI(n,e){const t={},r=e.length;for(let s=0;s<r;s++){const i=e[s];i.writable&&(t[i.server]=n[i.local])}return JSON.stringify(t)}class ka{constructor(e,t,r,s){this.url=e,this.method=t,this.handler=r,this.timeout=s,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gf(n){if(!n)throw Sa()}function EI(n,e){function t(r,s){const i=mf(n,s,e);return gf(i!==null),i}return t}function TI(n,e){function t(r,s){const i=mf(n,s,e);return gf(i!==null),yI(i,s,n.host,n._protocol)}return t}function _f(n){function e(t,r){let s;return t.getStatus()===401?t.getErrorText().includes("Firebase App Check token is invalid")?s=OT():s=VT():t.getStatus()===402?s=NT(n.bucket):t.getStatus()===403?s=LT(n.path):s=r,s.status=t.getStatus(),s.serverResponse=r.serverResponse,s}return e}function yf(n){const e=_f(n);function t(r,s){let i=e(r,s);return r.getStatus()===404&&(i=DT(n.path)),i.serverResponse=s.serverResponse,i}return t}function II(n,e,t){const r=e.fullServerUrl(),s=fi(r,n.host,n._protocol),i="GET",a=n.maxOperationRetryTime,c=new ka(s,i,TI(n,t),a);return c.errorHandler=yf(e),c}function wI(n,e){const t=e.fullServerUrl(),r=fi(t,n.host,n._protocol),s="DELETE",i=n.maxOperationRetryTime;function a(l,d){}const c=new ka(r,s,a,i);return c.successCodes=[200,204],c.errorHandler=yf(e),c}function AI(n,e){return n&&n.contentType||e&&e.type()||"application/octet-stream"}function RI(n,e,t){const r=Object.assign({},t);return r.fullPath=n.path,r.size=e.size(),r.contentType||(r.contentType=AI(null,e)),r}function bI(n,e,t,r,s){const i=e.bucketOnlyServerUrl(),a={"X-Goog-Upload-Protocol":"multipart"};function c(){let F="";for(let z=0;z<2;z++)F=F+Math.random().toString().slice(2);return F}const l=c();a["Content-Type"]="multipart/related; boundary="+l;const d=RI(e,r,s),p=vI(d,t),g="--"+l+`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class on{constructor(e,t){this._service=e,t instanceof Me?this._location=t:this._location=Me.makeFromUrl(t,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,t){return new on(e,t)}get root(){const e=new Me(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return ff(this._location.path)}get storage(){return this._service}get parent(){const e=dI(this._location.path);if(e===null)return null;const t=new Me(this._location.bucket,e);return new on(this._service,t)}_throwIfRoot(e){if(this._location.path==="")throw zT(e)}}function CI(n,e,t){n._throwIfRoot("uploadBytes");const r=bI(n.storage,n._location,pf(),new wt(e,!0),t);return n.storage.makeRequestWithTokens(r,Da).then(s=>({metadata:s,ref:n}))}function kI(n){n._throwIfRoot("getDownloadURL");const e=II(n.storage,n._location,pf());return n.storage.makeRequestWithTokens(e,Da).then(t=>{if(t===null)throw $T();return t})}function DI(n){n._throwIfRoot("deleteObject");const e=wI(n.storage,n._location);return n.storage.makeRequestWithTokens(e,Da)}function NI(n,e){const t=fI(n._location.path,e),r=new Me(n._location.bucket,t);return new on(n.storage,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ef="storage";function wA(n,e,t){return n=te(n),CI(n,e,t)}function AA(n){return n=te(n),kI(n)}function RA(n){return n=te(n),DI(n)}function bA(n,e){return n=te(n),LI(n,e)}function SA(n=zs(),e){n=te(n);const r=Ut(n,Ef).getImmediate({identifier:e}),s=Nl("storage");return s&&xI(r,...s),r}function xI(n,e,t,r={}){MI(n,e,t,r)}function UI(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new Na(t,r,s,e,ln)}function FI(){We(new Fe(Ef,UI,"PUBLIC").setMultipleInstances(!0)),Ne(yl,vl,""),Ne(yl,vl,"esm2017")}FI();const Tf="@firebase/installations",Va="0.6.18";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const If=1e4,wf=`w:${Va}`,Af="FIS_v2",BI="https://firebaseinstallations.googleapis.com/v1",jI=3600*1e3,$I="installations",qI="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const JI=/^[cdef][\w-]{21}$/,ko="";function XI(){try{const n=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(n),n[0]=112+n[0]%16;const t=YI(n);return JI.test(t)?t:ko}catch{return ko}}function YI(n){return QI(n).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nf=new Map;function Vf(n,e){const t=pi(n);Of(t,e),ZI(t,e)}function Of(n,e){const t=Nf.get(n);if(t)for(const r of t)r(e)}function ZI(n,e){const t=ew();t&&t.postMessage({key:n,fid:e}),tw()}let Yt=null;function ew(){return!Yt&&"BroadcastChannel"in self&&(Yt=new BroadcastChannel("[Firebase] FID Change"),Yt.onmessage=n=>{Of(n.data.key,n.data.fid)}),Yt}function tw(){Nf.size===0&&Yt&&(Yt.close(),Yt=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function La(n){let e;const t=await mi(n.appConfig,r=>{const s=sw(r),i=iw(n,s);return e=i.registrationPromise,i.installationEntry});return t.fid===ko?{installationEntry:await e}:{installationEntry:t,registrationPromise:e}}function sw(n){const e=n||{fid:XI(),registrationStatus:0};return Mf(e)}function iw(n,e){if(e.registrationStatus===0){if(!navigator.onLine){const s=Promise.reject(an.create("app-offline"));return{installationEntry:e,registrationPromise:s}}const t={fid:e.fid,registrationStatus:1,registrationTime:Date.now()},r=ow(n,t);return{installationEntry:t,registrationPromise:r}}else return e.registrationStatus===1?{installationEntry:e,registrationPromise:aw(n)}:{installationEntry:e}}async function ow(n,e){try{const t=await KI(n,e);return Bs(n.appConfig,t)}catch(t){throw Rf(t)&&t.customData.serverCode===409?await Lf(n.appConfig):await Bs(n.appConfig,{fid:e.fid,registrationStatus:0}),t}}async function aw(n){let e=await El(n.appConfig);for(;e.registrationStatus===1;)await Df(100),e=await El(n.appConfig);if(e.registrationStatus===0){const{installationEntry:t,registrationPromise:r}=await La(n);return r||t}return e}function El(n){return mi(n,e=>{if(!e)throw an.create("installation-not-found");return Mf(e)})}function Mf(n){return cw(n)?{fid:n.fid,registrationStatus:0}:n}function cw(n){return n.registrationStatus===1&&n.registrationTime+If<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function uw({appConfig:n,heartbeatServiceProvider:e},t){const r=lw(n,t),s=HI(n,t),i=e.getImmediate({optional:!0});if(i){const d=await i.getHeartbeatsHeader();d&&s.append("x-firebase-client",d)}const a={installation:{sdkVersion:wf,appId:n.appId}},c={method:"POST",headers:s,body:JSON.stringify(a)},l=await kf(()=>fetch(r,c));if(l.ok){const d=await l.json();return Sf(d)}else throw await Pf("Generate Auth Token",l)}function lw(n,{fid:e}){return`${bf(n)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ma(n,e=!1){let t;const r=await mi(n.appConfig,i=>{if(!xf(i))throw an.create("not-registered");const a=i.authToken;if(!e&&fw(a))return i;if(a.requestStatus===1)return t=hw(n,e),i;{if(!navigator.onLine)throw an.create("app-offline");const c=mw(i);return t=dw(n,c),c}});return t?await t:r.authToken}async function hw(n,e){let t=await Tl(n.appConfig);for(;t.authToken.requestStatus===1;)await Df(100),t=await Tl(n.appConfig);const r=t.authToken;return r.requestStatus===0?Ma(n,e):r}function Tl(n){return mi(n,e=>{if(!xf(e))throw an.create("not-registered");const t=e.authToken;return gw(t)?Object.assign(Object.assign({},e),{authToken:{requestStatus:0}}):e})}async function dw(n,e){try{const t=await uw(n,e),r=Object.assign(Object.assign({},e),{authToken:t});return await Bs(n.appConfig,r),t}catch(t){if(Rf(t)&&(t.customData.serverCode===401||t.customData.serverCode===404))await Lf(n.appConfig);else{const r=Object.assign(Object.assign({},e),{authToken:{requestStatus:0}});await Bs(n.appConfig,r)}throw t}}function xf(n){return n!==void 0&&n.registrationStatus===2}function fw(n){return n.requestStatus===2&&!pw(n)}function pw(n){const e=Date.now();return e<n.creationTime||n.creationTime+n.expiresIn<e+jI}function mw(n){const e={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},n),{authToken:e})}function gw(n){return n.requestStatus===1&&n.requestTime+If<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _w(n){const e=n,{installationEntry:t,registrationPromise:r}=await La(e);return r?r.catch(console.error):Ma(e).catch(console.error),t.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function yw(n,e=!1){const t=n;return await vw(t),(await Ma(t,e)).token}async function vw(n){const{registrationPromise:e}=await La(n);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Uf="installations",Tw="installations-internal",Iw=n=>{const e=n.getProvider("app").getImmediate(),t=Ew(e),r=Ut(e,"heartbeat");return{app:e,appConfig:t,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},ww=n=>{const e=n.getProvider("app").getImmediate(),t=Ut(e,Uf).getImmediate();return{getId:()=>_w(t),getToken:s=>yw(t,s)}};function Aw(){We(new Fe(Uf,Iw,"PUBLIC")),We(new Fe(Tw,ww,"PRIVATE"))}Aw();Ne(Tf,Va);Ne(Tf,Va,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const js="analytics",Rw="firebase_id",bw="origin",Sw=60*1e3,Pw="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",xa="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kw(n){if(!n.startsWith(xa)){const e=xe.create("invalid-gtag-resource",{gtagURL:n});return Ve.warn(e.message),""}return n}function Ff(n){return Promise.all(n.map(e=>e.catch(t=>t)))}function Dw(n,e){let t;return window.trustedTypes&&(t=window.trustedTypes.createPolicy(n,e)),t}function Nw(n,e){const t=Dw("firebase-js-sdk-policy",{createScriptURL:kw}),r=document.createElement("script"),s=`${xa}?l=${n}&id=${e}`;r.src=t?t==null?void 0:t.createScriptURL(s):s,r.async=!0,document.head.appendChild(r)}function Vw(n){let e=[];return Array.isArray(window[n])?e=window[n]:window[n]=e,e}async function Ow(n,e,t,r,s,i){const a=r[s];try{if(a)await e[a];else{const l=(await Ff(t)).find(d=>d.measurementId===s);l&&await e[l.appId]}}catch(c){Ve.error(c)}n("config",s,i)}async function Lw(n,e,t,r,s){try{let i=[];if(s&&s.send_to){let a=s.send_to;Array.isArray(a)||(a=[a]);const c=await Ff(t);for(const l of a){const d=c.find(g=>g.measurementId===l),p=d&&e[d.appId];if(p)i.push(p);else{i=[];break}}}i.length===0&&(i=Object.values(e)),await Promise.all(i),n("event",r,s||{})}catch(i){Ve.error(i)}}function Mw(n,e,t,r){async function s(i,...a){try{if(i==="event"){const[c,l]=a;await Lw(n,e,t,c,l)}else if(i==="config"){const[c,l]=a;await Ow(n,e,t,r,c,l)}else if(i==="consent"){const[c,l]=a;n("consent",c,l)}else if(i==="get"){const[c,l,d]=a;n("get",c,l,d)}else if(i==="set"){const[c]=a;n("set",c)}else n(i,...a)}catch(c){Ve.error(c)}}return s}function xw(n,e,t,r,s){let i=function(...a){window[r].push(arguments)};return window[s]&&typeof window[s]=="function"&&(i=window[s]),window[s]=Mw(i,n,e,t),{gtagCore:i,wrappedGtag:window[s]}}function Uw(n){const e=window.document.getElementsByTagName("script");for(const t of Object.values(e))if(t.src&&t.src.includes(xa)&&t.src.includes(n))return t;return null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fw=30,Bw=1e3;class jw{constructor(e={},t=Bw){this.throttleMetadata=e,this.intervalMillis=t}getThrottleMetadata(e){return this.throttleMetadata[e]}setThrottleMetadata(e,t){this.throttleMetadata[e]=t}deleteThrottleMetadata(e){delete this.throttleMetadata[e]}}const Bf=new jw;function $w(n){return new Headers({Accept:"application/json","x-goog-api-key":n})}async function qw(n){var e;const{appId:t,apiKey:r}=n,s={method:"GET",headers:$w(r)},i=Pw.replace("{app-id}",t),a=await fetch(i,s);if(a.status!==200&&a.status!==304){let c="";try{const l=await a.json();!((e=l.error)===null||e===void 0)&&e.message&&(c=l.error.message)}catch{}throw xe.create("config-fetch-failed",{httpStatus:a.status,responseMessage:c})}return a.json()}async function zw(n,e=Bf,t){const{appId:r,apiKey:s,measurementId:i}=n.options;if(!r)throw xe.create("no-app-id");if(!s){if(i)return{measurementId:i,appId:r};throw xe.create("no-api-key")}const a=e.getThrottleMetadata(r)||{backoffCount:0,throttleEndTimeMillis:Date.now()},c=new Gw;return setTimeout(async()=>{c.abort()},Sw),jf({appId:r,apiKey:s,measurementId:i},a,c,e)}async function jf(n,{throttleEndTimeMillis:e,backoffCount:t},r,s=Bf){var i;const{appId:a,measurementId:c}=n;try{await Hw(r,e)}catch(l){if(c)return Ve.warn(`Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${c} provided in the "measurementId" field in the local Firebase config. [${l==null?void 0:l.message}]`),{appId:a,measurementId:c};throw l}try{const l=await qw(n);return s.deleteThrottleMetadata(a),l}catch(l){const d=l;if(!Ww(d)){if(s.deleteThrottleMetadata(a),c)return Ve.warn(`Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${c} provided in the "measurementId" field in the local Firebase config. [${d==null?void 0:d.message}]`),{appId:a,measurementId:c};throw l}const p=Number((i=d==null?void 0:d.customData)===null||i===void 0?void 0:i.httpStatus)===503?jc(t,s.intervalMillis,Fw):jc(t,s.intervalMillis),g={throttleEndTimeMillis:Date.now()+p,backoffCount:t+1};return s.setThrottleMetadata(a,g),Ve.debug(`Calling attemptFetch again in ${p} millis`),jf(n,g,r,s)}}function Hw(n,e){return new Promise((t,r)=>{const s=Math.max(e-Date.now(),0),i=setTimeout(t,s);n.addEventListener(()=>{clearTimeout(i),r(xe.create("fetch-throttle",{throttleEndTimeMillis:e}))})})}function Ww(n){if(!(n instanceof je)||!n.customData)return!1;const e=Number(n.customData.httpStatus);return e===429||e===500||e===503||e===504}class Gw{constructor(){this.listeners=[]}addEventListener(e){this.listeners.push(e)}abort(){this.listeners.forEach(e=>e())}}async function Kw(n,e,t,r,s){if(s&&s.global){n("event",t,r);return}else{const i=await e,a=Object.assign(Object.assign({},r),{send_to:i});n("event",t,a)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Qw(){if(xl())try{await Ul()}catch(n){return Ve.warn(xe.create("indexeddb-unavailable",{errorInfo:n==null?void 0:n.toString()}).message),!1}else return Ve.warn(xe.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;return!0}async function Jw(n,e,t,r,s,i,a){var c;const l=zw(n);l.then(b=>{t[b.measurementId]=b.appId,n.options.measurementId&&b.measurementId!==n.options.measurementId&&Ve.warn(`The measurement ID in the local Firebase config (${n.options.measurementId}) does not match the measurement ID fetched from the server (${b.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(b=>Ve.error(b)),e.push(l);const d=Qw().then(b=>{if(b)return r.getId()}),[p,g]=await Promise.all([l,d]);Uw(i)||Nw(i,p.measurementId),s("js",new Date);const v=(c=a==null?void 0:a.config)!==null&&c!==void 0?c:{};return v[bw]="firebase",v.update=!0,g!=null&&(v[Rw]=g),s("config",p.measurementId,v),p.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xw{constructor(e){this.app=e}_delete(){return delete mr[this.app.options.appId],Promise.resolve()}}let mr={},Il=[];const wl={};let to="dataLayer",Yw="gtag",Al,$f,Rl=!1;function Zw(){const n=[];if(Ml()&&n.push("This is a browser extension environment."),jp()||n.push("Cookies are not available."),n.length>0){const e=n.map((r,s)=>`(${s+1}) ${r}`).join(" "),t=xe.create("invalid-analytics-context",{errorInfo:e});Ve.warn(t.message)}}function eA(n,e,t){Zw();const r=n.options.appId;if(!r)throw xe.create("no-app-id");if(!n.options.apiKey)if(n.options.measurementId)Ve.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${n.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw xe.create("no-api-key");if(mr[r]!=null)throw xe.create("already-exists",{id:r});if(!Rl){Vw(to);const{wrappedGtag:i,gtagCore:a}=xw(mr,Il,wl,to,Yw);$f=i,Al=a,Rl=!0}return mr[r]=Jw(n,Il,wl,e,Al,to,t),new Xw(n)}function PA(n=zs()){n=te(n);const e=Ut(n,js);return e.isInitialized()?e.getImmediate():tA(n)}function tA(n,e={}){const t=Ut(n,js);if(t.isInitialized()){const s=t.getImmediate();if(Ct(e,t.getOptions()))return s;throw xe.create("already-initialized")}return t.initialize({options:e})}function nA(n,e,t,r){n=te(n),Kw($f,mr[n.app.options.appId],e,t,r).catch(s=>Ve.error(s))}const bl="@firebase/analytics",Sl="0.10.17";function rA(){We(new Fe(js,(e,{options:t})=>{const r=e.getProvider("app").getImmediate(),s=e.getProvider("installations-internal").getImmediate();return eA(r,s,t)},"PUBLIC")),We(new Fe("analytics-internal",n,"PRIVATE")),Ne(bl,Sl),Ne(bl,Sl,"esm2017");function n(e){try{const t=e.getProvider(js).getImmediate();return{logEvent:(r,s,i)=>nA(t,r,s,i)}}catch(t){throw xe.create("interop-component-reg-failed",{reason:t})}}}rA();export{Et as G,dA as a,SA as b,PA as c,fT as d,_A as e,iA as f,uA as g,sA as h,Jm as i,wA as j,AA as k,TA as l,hA as m,IA as n,oA as o,RA as p,fA as q,bA as r,vA as s,mA as t,EA as u,gA as v,pA as w,yA as x,cA as y,aA as z};
